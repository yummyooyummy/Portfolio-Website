      ...
      projects: [
        ...
        },
        {
          ...
          sections: [
            ...
            { heading: "对照测试：0% → 100%", body: "同一套界面设计，两份文件。Figma Make 原始产出 88 层、88 个问题；把命名规范交给 AI 重新生成后 87 层、0 个必须修，剩 24 条结构类建议。\n\n**AI 会严格遵守你写下的规则，但不会做你没说的事。** 那 24 条全是规范里没写的两件事：多余的包装层、该组件化的重复元素。", images: [{ src: "/assetgate-compare.png", alt: "对照测试：原始产出合格率 0%（88 层 88 个问题），按规范重新生成后 100%（87 层 0 个必须修、24 条建议）" }] },
